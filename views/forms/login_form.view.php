     ...
     <div class="flex bg-gray-900 border-t-4 border-red-600 w-2/6 h-fit mt-2 rounded-2xl text-white  shadow-2xl shadow-red-500 bg-opacity-50">
          <div class="flex-1   ">
               ...
               <form action="" class="m-5" method="post">
                    <input class=" appearance-none border rounded w-full py-2 px-3 mt-5 bg-slate-800 <?php echo  $emailValid ?  'border-white' : 'border-red-600' ?> bg-opacity-0" style="border-radius:20px;" id="email" type="email" name="email" placeholder="Email">
                    <small class="text-red-400" id="emailError"> <?= $emailError ?></small>
                    <input class="<?php echo $passwordValid ?  'border-white' : 'border-red-600' ?> appearance-none border rounded w-full py-2 px-3 mt-5 bg-slate-800 mb-3 bg-opacity-0" style="border-radius:20px;" id="password" type="password" name="password" placeholder="Your password">
