<div class="w-[100%] " id="banner-container">
    <div class="relative h-[60vh] w-[100%]" style="overflow-x: hidden; overflow-y: hidden;">
        ...
        <div class="slide relative">
            <img class="w-full h-[65vh] object-cover" src="https://www.newcanaanymca.org/wp-content/uploads/2021/11/Moana-Movie-Poster-landscape.jpg">
            <div class="absolute inset-0 bg-gray-600 bg-opacity-50"></div>
        ...
        <div class="slide relative">
            <img class="w-full h-[65vh] object-cover" src="https://www.bt.com/content/dam/bt/portal/images/articles/tv/tv-drama-the-last-of-us-key-art-now-sky-atlantic.jpg/jcr:content/renditions/landscape-desktop.764.430.jpg">
            <div class="absolute inset-0 bg-gray-600 bg-opacity-50"></div>
            <div class="absolute bottom-40 w-screen text-white flex items-center flex-col" style="margin-top:-70%">
                <p class="text-3xl">TIME TO START WATCHING</p>
        ...
        <div class="slide relative">
            <img class="w-full h-[65vh] object-cover" src="https://pic9.iqiyipic.com/image/20210721/22/39/a_100466598_m_601_en_m1_1080_608.jpg">
            <div class="absolute inset-0 bg-gray-600 bg-opacity-50"></div>
            <div class="absolute bottom-40 w-screen text-white flex items-center flex-col" style="margin-top:-70%">
                <p class="text-3xl">TIME TO START WATCHING</p>
        ...
        <!-- The previous button -->
        <a class="absolute left-0 top-60 p-4 -translate-y-1/2 bg-black/30 hover:bg-black/50 text-white hover:text-amber-500 cursor-pointer" onclick="moveSlide(-1)">❮</a>

        <!-- The next button -->
        <a class="absolute right-0 top-60 p-4 -translate-y-1/2 bg-black/30 hover:bg-black/50 text-white hover:text-amber-500 cursor-pointer" onclick="moveSlide(1)">❯</a>
